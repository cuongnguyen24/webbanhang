        ...
        <?php
            ...
            if (isset($_POST['btnSubmit'])) {
                ...
                if (mysqli_query($conn, $sqlNhanVien)) {
                    echo "<script>alert('Sửa thông tin nhân viên thành công'); window.location.href = '/webbanhang/admin/dashboard/staff/index.php';</script>";
                } else {
            ...
            <div class="main">
                <div id="back">
                    ...
                    <a href="/webbanhang/admin/dashboard/staff/index.php">Quay lại</a>
                </div>
                <div class="wrapper">
                    <div></div>
                    <p class="title">
