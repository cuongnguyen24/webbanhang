                        ...
                        <div class="pro-loop">
                            <div class="pro-loop-wrap">
                                <div class="pro-loop-image">
                                    <a href="<?php echo str_replace('/webbanhang', '', $sanpham['chitietsp']); ?>" class="pro-loop-image-item">
                                        ...
                                        ?>	
                                        <picture>
                                                <source srcset="<?php echo '/admin/dashboard/products/'. $row1["duongDanAnh"]; ?>" 
                                                data-srcset="<?php echo '/admin/dashboard/products/'. $row1["duongDanAnh"]; ?>" 
                                                media="(max-width: 767px)" 
                                                alt="img <?php echo $sanpham['tenSanPham']; ?>">
                                                <img class=" lazyloaded" 
                                                src="<?php echo '/admin/dashboard/products/'. $row1["duongDanAnh"]; ?>" 
                                                data-src="<?php echo '/admin/dashboard/products/'. $row1["duongDanAnh"]; ?>" 
                                                alt="<?php echo $sanpham['tenSanPham']; ?>" 
                                                style="max-width: 237.5px;">
                                        </picture>
                                        <picture>
                                                <source srcset="<?php echo '/admin/dashboard/products/'. $row1["duongDanAnh"]; ?>" 
                                                data-srcset="<?php echo '/admin/dashboard/products/'. $row1["duongDanAnh"]; ?>" 
                                                media="(max-width: 767px)" alt="img <?php echo $sanpham['tenSanPham']; ?>">
                                                <img class=" lazyloaded" 
                                                src="<?php echo '/admin/dashboard/products/'. $row1["duongDanAnh"]; ?>" 
                                                data-src="<?php echo '/admin/dashboard/products/'. $row1["duongDanAnh"]; ?>" 
                                                alt="<?php echo $sanpham['tenSanPham']; ?>" 
                                ...
                                <h3 class="pro-loop-name">
							        <a href="/products/bo-lien-coc-mau-xanh-da-troi" title="
