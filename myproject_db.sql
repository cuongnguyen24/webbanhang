...
--
-- Host: localhost:3306
-- Generation Time: Apr 22, 2025 at 03:14 PM
...
('MDM13', 'ao mu', '/collections/ao-mu/', 'MDM12', 1),
...
INSERT INTO `giohang` (`maKhachHang`, `maSanPham`, `soLuong`, `maSize`) VALUES
('kh01', 'MSP13', 1, 'S');
...
('kh01', 'tk01', 'Nguyễn Bá Quốc Cường', '2004-07-24', 1, 1, 'daodinhbinh612004@gmail.com', '0382951529', NULL),
...
('MSP40', 'ao dai tay', 'MNCC1', 'MDM13', 'ql01', 1200000, 'hien dai', '/webbanhang/products/ao-dai-tay/', ' '),
...
CREATE TABLE `sanphamyeuthich` (
  `maSanPhamYeuThich` int NOT NULL,
  `maKhachHang` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `maSanPham` varchar(20) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `khuyenmaidonhang`
--
...
--
ALTER TABLE `anhsanpham`
  MODIFY `maAnh` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;

--
-- AUTO_INCREMENT for table `diachi`
--
ALTER TABLE `diachi`
  MODIFY `maDiaChi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `sanphamyeuthich`
--
ALTER TABLE `sanphamyeuthich`
  MODIFY `maSanPhamYeuThich` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
-- Constraints for table `khuyenmaidonhang`
--
ALTER TABLE `khuyenmaidonhang`
...
--
-- Constraints for table `sizesanpham`
--
ALTER TABLE `sizesanpham`
