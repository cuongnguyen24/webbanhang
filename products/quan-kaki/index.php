                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $query = "SELECT SUM(sizesanpham.soLuong)
                        FROM sizesanpham
                        INNER JOIN sanpham ON sizesanpham.maSanPham = sanpham.maSanPham
                        WHERE sanpham.maSanPham = $masv AND sizesanpham.soLuong > 0
                        ";
                    $count_tinhtrang = mysqli_query($conn,$query);
                                    ...
                                    <div class="productWrapRight">
                                            <div class="productWrapDetail">
                                                ...
                                                <div class="productSku">
                                                    Mã sản phẩm: <strong><?php echo $masv?></strong>
                                                </div>
