...
<?php
                        ...
                        <div class="productWrapRight">
                            <div class="productWrapDetail">
                                ...
                                <div class="productInfoStatus">
                                    <span class="productInfoStatus_tt">Tình trạng:</span><span class="productInfoStatus_check">Còn hàng</span>
                                </div>

                                <div class="productSku">
                                    Mã sản phẩm: <strong>NB2S24-OP1-M01-PB-0M</strong>
                                </div>
                                    ...
                                    <div class="productPriceBox">
                                        <span class="productPriceBox_tt">Giá:</span>
                                            <p class="productPriceBox_price">
                                                <span class="productPriceMain">185.000₫</span>
                                                <del class="productPriceCompare d-none">185.000₫</del>									
    ...
    <?php
        include($_SERVER['DOCUMENT_ROOT'] . '/webbanhang/collections/includes/footer.php');
    ?>
    <script>
