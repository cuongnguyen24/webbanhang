    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="/webbanhang/staff/accountstaff.php" target="_self">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a id="detail_button" title="Xem chi tiết đơn hàng" href="/webbanhang/staff/dashboard/order/order_detail.php?smdh=<?php echo $row['maDonHang'] ?>">
